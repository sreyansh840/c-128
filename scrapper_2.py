...
time.sleep(10)
headers = ["star", "constellation", "right_ascension", "declination", "app.mg.", "distance", "spectral_type", "brown_dwarf", "mass", "radius","orbital_period","semimajor_axis","ecc.","discovery_year"]
planet_data = []
new_planet_data = []
def scrape():
